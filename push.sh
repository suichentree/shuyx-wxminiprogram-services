...
REMOTE_GITEE_URL="https://gitee.com/suichenTree/shuyx-wxminiprogram-services.git"

# 源代码 github 远程仓库名称和URL
REMOTE_GITHUB_NAME="github-origin"
REMOTE_GITHUB_URL="https://github.com/suichentree/shuyx-wxminiprogram-services.git"
